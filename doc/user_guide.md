...
By default, the output directory is created in the operating system default root
...
In case you get an error saying "Failed to create the graph", try changing the
